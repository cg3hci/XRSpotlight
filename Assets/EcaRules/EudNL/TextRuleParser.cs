...
namespace EcaRules
{
    public class TextRuleParser : IEcaRuleParser, IECARulesParserListener, IAntlrErrorListener<IToken>
    {
        ...
        private EcaPosition _position;
        private EcaPath _path;
        ...
        public Dictionary<string, EcaPosition> PositionDeclarations { get; internal set; }
        public Dictionary<string, EcaColor> ColorDeclarations { get; internal set; } 
        public Dictionary<string, EcaPath> PathDeclarations { get; internal set; }

        public TextRuleParser()
        {
            _color = new EcaColor();
            ObjectDeclarations = new ArrayList<Pair<Type, GameObject>>();
            PositionDeclarations = new Dictionary<string, EcaPosition>();
            PathDeclarations = new Dictionary<string, EcaPath>();
        ...
        {
            _path = new EcaPath(new List<EcaPosition>());
