...
[DisallowMultipleComponent]
    public class EcaFirearm : MonoBehaviour
    {
        /// <summary>
        ...
        /// </summary>
        [EcaStateVariable("charge", EcaRules4AllType.Integer)] public int charge;
        ...
        [EcaAction(typeof(EcaFirearm), "recharges", typeof(int))]
        ...
        [EcaAction(typeof(EcaFirearm), "fires", typeof(ECAObject))]
        public void Fires(ECAObject obj)
        {
            if (charge > 0)
            {
                ...
                if (bulletPrefab != null)
                {
                    ...
                    bulletInstance.GetComponent<Rigidbody>().AddForce(transform.forward * bulletPrefab.GetComponent<EcaBullet>().speed);
                }
        ...
        [EcaAction(typeof(EcaFirearm), "aims", typeof(ECAObject))]
