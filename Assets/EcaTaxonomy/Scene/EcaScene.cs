...
public class EcaScene : MonoBehaviour
{
    ...
    /// </summary>
    [EcaStateVariable("name", EcaRules4AllType.Text)] public string name;
    /// <summary>
    /// <b>Position</b>: the position of the scene
    /// </summary>
    [EcaStateVariable("position", EcaRules4AllType.Position)] public EcaPosition position;
    ...
    /// <summary>
    /// <b>_Teleports</b>: a passive verb, see <see cref="EcaCharacter"/> for the implementation
    /// </summary>
    //TODO: implement
    [EcaAction(typeof(EcaCharacter), "teleports to", typeof(EcaScene))]
