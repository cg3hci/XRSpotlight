...
public class EcaRobot : MonoBehaviour
{
    ...
    [EcaAction(typeof(EcaRobot), "runs to", typeof(EcaPosition))]
    ...
    [EcaAction(typeof(EcaRobot), "runs on", typeof(EcaPath))]
    ...
    [EcaAction(typeof(EcaRobot), "swims to", typeof(EcaPosition))]
    ...
    /// </summary>
    /// <param name="p">The path</param>
    [EcaAction(typeof(EcaRobot), "swims on", typeof(EcaPath))]
    ...
    [EcaAction(typeof(EcaRobot), "walks to", typeof(EcaPosition))]
    ...
    /// </summary>
    /// <param name="p">The path</param>
    [EcaAction(typeof(EcaRobot), "walks on", typeof(EcaPath))]
