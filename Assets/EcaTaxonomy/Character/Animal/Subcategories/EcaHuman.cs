...
public class EcaHuman : MonoBehaviour
{
    ...
    [EcaAction(typeof(EcaHuman), "runs to", typeof(EcaPosition))]
    ...
    [EcaAction(typeof(EcaHuman), "runs on", typeof(EcaPath))]
    ...
    [EcaAction(typeof(EcaHuman), "swims to", typeof(EcaPosition))]
    ...
    /// </summary>
    /// <param name="p">The path</param>
    [EcaAction(typeof(EcaHuman), "swims on", typeof(EcaPath))]
    ...
    [EcaAction(typeof(EcaHuman), "walks to", typeof(EcaPosition))]
    ...
    /// </summary>
    /// <param name="p">The path</param>
    [EcaAction(typeof(EcaHuman), "walks on", typeof(EcaPath))]
