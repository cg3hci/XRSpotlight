...
/// </summary>
[EcaRules4All("video")]
[RequireComponent(typeof(EcaInteraction), typeof(VideoPlayer))] //gerarchia 
...
public class EcaVideo : MonoBehaviour
{
    ...
    /// </summary>
    [EcaStateVariable("source", EcaRules4AllType.Text)]
    public string source;

    /// <summary>
    /// <b>Volume</b> is the video volume.
    /// </summary>
    [EcaStateVariable("volume", EcaRules4AllType.Float)]
    public float volume;

    /// <summary>
    /// <b> MaxVolume</b> is the video max volume.
    /// </summary>
    [EcaStateVariable("maxVolume", EcaRules4AllType.Float)]
    ...
    /// </summary>
    [EcaAction(typeof(EcaVideo), "plays")]
    public void Plays()
    {
    ...
    /// </summary>
    [EcaAction(typeof(EcaVideo), "pauses")]
    public void Pauses()
    {
    ...
    /// </summary>
    [EcaAction(typeof(EcaVideo), "stops")]
    public void Stops()
    {
        this.playing.Assign(ECABoolean.BoolType.NO);
    ...
    [EcaAction(typeof(EcaVideo), "changes", "volume", "to", typeof(float))]
    ...
    [EcaAction(typeof(EcaVideo), "changes", "current-time", "to", typeof(double))]
    ...
    [EcaAction(typeof(EcaVideo), "changes", "source", "to", typeof(string))]
