...
/// <summary>
/// <b>ECALight</b> is an <see cref="EcaInteraction"/> subclass that represents a light source. It can control a light source
...
public class EcaLight : MonoBehaviour
{
    ...
    /// </summary>
    [EcaStateVariable("intensity", EcaRules4AllType.Float)] public float intensity = 1;
    /// <summary>
    /// <b> MaxIntensity </b> is the maximum intensity of the light source.
    /// </summary>
    [EcaStateVariable("maxIntensity", EcaRules4AllType.Float)] public float maxIntensity = 10;
    /// <summary>
    /// <b> Color </b> is the color of the light source.
    /// </summary>
    [EcaStateVariable("color", EcaRules4AllType.Color)] public Color color = new Color(1, 0.95686271f, 0.8392157f, 1);
    ...
    [EcaAction(typeof(EcaLight), "turns", typeof(ECABoolean))]
    ...
    [EcaAction(typeof(EcaLight), "increases", "intensity", "by", typeof(float))]
    ...
    [EcaAction(typeof(EcaLight), "decreases","intensity", "by", typeof(float))]
    ...
    [EcaAction(typeof(EcaLight), "sets", "intensity", "to", typeof(float))]
    ...
    [EcaAction(typeof(EcaLight), "changes","color", "to", typeof(EcaColor))]
